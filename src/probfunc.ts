...
// gamma of x
export function gammafn(x: number) {
...
export function gammap(a: number, x: number) {
...
// combinations of n, m
export function combination(n: number, m: number) {
...
export function combinationln(n: number, m: number) {
    return factorialln(n) - factorialln(m) - factorialln(n - m);
}

// permutations of n, m
export function permutation(n: number, m: number) {
...
export function betaln(x: number, y: number) {
...
export function randg(shape: number = 1) {
    var oalph = shape;
    var a1, a2, u, v, x;
